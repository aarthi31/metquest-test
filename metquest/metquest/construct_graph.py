# -*- coding: utf-8 -*-
"""
Created on Sun Apr 29 15:34:39 2018
                ...
                for numincom in range(len(ALL_POSSIBLE_COMBIS[ncom])):
                    ...
                    file_name = file_name + \
                        ORGANISMS_NAMES[ALL_POSSIBLE_COMBIS[ncom]
                                        [numincom]] + '_'
                H = create_graph_with_internal_reaction(current_combination)
                H, full_name_map = create_graph_with_exchange_reactions(
                    H, current_combination, PARTIAL_NAME_MAP)
                nx.write_gpickle(H, file_name + '.gpickle')
                print('Graph created for file(s) in', PATH_NAME_WITH_MODELS)
